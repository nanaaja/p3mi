        ...
        <div class='col-md-5'>
            <div class='box '>
                <div class='box-header'>
                    <h3 class='box-title'>Grafik Pendukung by Relawan </h3> (<?php
                                                                                $data_wilayah = '';
                                                                                if ($_GET['level'] == 1) {
                                ...
                                <tbody>
                                    ...
                                    foreach ($wilayah as $r) {
                                        ...
                                        <tr> <?php
                                                ...
                                                <th><?= $r->nama_prov; ?></th>
                                                <th>
                                                    <center><?= $this->m_masterdata->jml_suara_pendukung_per_wilayah($r->id_prov, 1); ?>
                                                </th>
                                                <th>
                                                    <?php
                                                    $link = site_url("MasterData/grafik_pendukung_by_relawan?level=2&id=" . $r->id_prov); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                ...
                                                <th>
                                                    <center><?= $this->m_masterdata->jml_suara_pendukung_per_wilayah($r->id_kab, 2); ?>
                                                </th>
                                                <th>
                                                    <?php
                                                    $link = site_url("MasterData/grafik_pendukung_by_relawan?level=3&id=" . $r->id_kab); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                    <?php
                                                } elseif ($_GET['level'] == 3) { ?>
                                                <th>
                                                    <center><?= $no; ?>
                                                ...
                                                <th>
                                                    <center><?= $this->m_masterdata->jml_suara_pendukung_per_wilayah($r->id_kec, 3); ?>
                                                </th>
                                                <th>
                                                    <center>
                                                        <?php
                                                        $link = site_url("MasterData/grafik_pendukung_by_relawan?level=4&id=" . $r->id_kec); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                        <?php
                                                    } elseif ($_GET['level'] == 4) { ?>
                                                <th>
                                                    <center><?= $no; ?>
                                                ...
                                                <th>
                                                    <center><?= $this->m_masterdata->jml_suara_pendukung_per_wilayah($r->id_kel, 4); ?>
                                                </th>
                                                <th>
                                                    <center><?php
                ...
                new Chart("myChart", {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'Grafik Suara Pendukung By Relawan  ' + wil
                            }
                        }
                    }
                });
