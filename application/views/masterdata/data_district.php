...
<section class="content">
        ...
        <div class='col-md-12'>
            <div class='box '>
                <div class='box-header'>
                    <h3 class='box-title'>Data district </h3>
                    <button class="btn btn-primary my-2 pull-right mx-3" data-toggle="modal" data-target="#add-district"><i class="fa fa-plus"></i> Add Data</button> &nbsp;
                ...
                <div class='box-body pad'>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="district-table" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>No</th>
    ...
    <!-- Modal tambah data -->
    <div class="modal fade add-district" id="add-district" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="tambah-district" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Country</label>
                            <select class="form-control" style="width:100%" name="country_id" id="country_id">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="district_name" name="district_name" placeholder="Jeddah" required>
                            <input type="hidden" class="form-control" name="tipe_form" value="add">
                        </div>
                        <div class="form-group">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var table = $('#district-table').DataTable({
                    "ajax": {
                        url: '<?php echo site_url("MasterData/district_page"); ?>',
                        type: 'POST'
                    },
                    ...
                    "columnDefs": [{
...

                        {
                            ...
                            "render": function(data, type, row, meta) {
								if(role == 'superadmin'){
									return "<a href=<?php echo site_url('MasterData/edit_district/'); ?>" +
										data +
										"><button class='btn btn-primary btn-md' name='edit'><i class='fa fa-edit  text-white-50 mr-1'></i>  </button></a> <button type='button' class='btn btn-danger btn-md' name='hapus' district_id=" +
                ...
                $('#tambah-district').on('submit', function(event) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Toast.fire({
                                type: 'success',
                                title: 'district Berhasil ditambahkan'
                            });
                            $('#tambah-district').trigger("reset");
                            setTimeout(function() {
            ...
            function edit(id) {
                ...
                Swal.fire({
                    title: 'Are you sure delete district this..?',
                    text: "",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: '<?php echo site_url('MasterData/hapus_district'); ?>',
                            data: {
