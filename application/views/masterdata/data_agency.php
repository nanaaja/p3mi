...
<section class="content">
        ...
        <div class='col-md-12'>
            <div class='box '>
                <div class='box-header'>
                    ...
                    <button class="btn btn-primary my-2 pull-right mx-3" data-toggle="modal" data-target="#add-agency"><i class="fa fa-plus"></i> Add Data</button> &nbsp;
                ...
                <div class='box-body pad'>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="agency-table" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>No</th>
    ...
    <!-- Modal tambah data -->
    <div class="modal fade add-agency" id="add-agency" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="tambah-agency" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Name</label>
                            <input type="text" class="form-control" id="agency_name" name="agency_name" placeholder="agency DKI JAKARTA" required>
                            <input type="hidden" class="form-control" name="tipe_form" value="add">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">agency License</label>
                            <input type="text" class="form-control" id="agency_license" name="agency_license" placeholder="agency/001/2024" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Address</label>
                            <textarea class="form-control" id="agency_address" name="agency_address" placeholder="JL ABC"  required></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-single" style="width:100%" id="agency_district" name="agency_district">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var table = $('#agency-table').DataTable({
                    "ajax": {
                        url: '<?php echo site_url("MasterData/agency_page"); ?>',
                        type: 'POST'
                    },
                    ...
                    "columnDefs": [{
...

                        {
                            ...
                            "render": function(data, type, row, meta) {
								if(role == 'superadmin'){
									return "<a href=<?php echo site_url('MasterData/edit_agency/'); ?>" +
										data +
										"><button class='btn btn-primary btn-md' name='edit'><i class='fa fa-edit  text-white-50 mr-1'></i>  </button></a> <button type='button' class='btn btn-danger btn-md' name='hapus' agency_id=" +
                ...
                $('#tambah-agency').on('submit', function(event) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Toast.fire({
                                type: 'success',
                                title: 'agency Berhasil ditambahkan'
                            });
                            $('#tambah-agency').trigger("reset");
                            setTimeout(function() {
                ...
                $(document).on('click', '.add-agency', function() {
                    var id_po_produk = $(this).attr('id_po_produk');
                    $('#m_add_agency').modal('show');
                });
            ...
            function edit(id) {
                ...
                Swal.fire({
                    title: 'Are you sure delete agency this..?',
                    text: "",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: '<?php echo site_url('MasterData/hapus_agency'); ?>',
                            data: {
                                agency_id: agency_id
                            },
                            dataType: "json",
