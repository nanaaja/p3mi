        ...
        <div class='col-md-12'>
            <div class='box '>
                <div class='box-header'>
                    <h3 class='box-title'>Data BLK </h3>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add BLK</h5>
                ...
                <div class="modal-body">
                    <form id="tambah-blk" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="blk_name" name="blk_name" placeholder="BLK DKI JAKARTA" required>
                            <input type="hidden" class="form-control" name="tipe_form" value="add">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">BLK License</label>
                            <input type="text" class="form-control" id="blk_license" name="blk_license" placeholder="BLK/001/2024" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Address</label>
                            <textarea class="form-control" id="blk_address" name="blk_address" placeholder="JL ABC"  required></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-single" style="width:100%" id="blk_district" name="blk_district">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="blk_status" name="blk_status" required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Add BLK</button>
                </div>
                </form>
            </div>
        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var table = $('#blk-table').DataTable({
                    "ajax": {
                        url: '<?php echo site_url("MasterData/blk_page"); ?>',
                        type: 'POST'
                    },
                    ...
                    "columnDefs": [{
...

                        {
                            ...
                            "render": function(data, type, row, meta) {
								if(role == 'superadmin'){
									return "<a href=<?php echo site_url('MasterData/edit_blk/'); ?>" +
										data +
                ...
                $('#tambah-blk').on('submit', function(event) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?php echo site_url('MasterData/add_blk'); ?>',
                        ...
                        success: function(data) {
                            ...
                            setTimeout(function() {
                                window.location.href =
                                    '<?php echo site_url('MasterData/blk'); ?>';
                                window.clearTimeout();
                            }, 1000);
                ...
                $(document).on('change', 'select[name="id_kecamatan"]', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $("select[name='blk_district']").html(data)
            ...
            function edit(id) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: '<?php echo site_url('MasterData/hapus_blk'); ?>',
                            data: {
                                blk_id: blk_id
                            },
                            dataType: "json",
