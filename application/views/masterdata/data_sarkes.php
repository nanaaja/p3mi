        ...
        <div class='col-md-12'>
            <div class='box '>
                <div class='box-header'>
                    <h3 class='box-title'>Data SARKES </h3>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add SARKES</h5>
                ...
                <div class="modal-body">
                    <form id="tambah-sarkes" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sarkes_name" name="sarkes_name" placeholder="sarkes DKI JAKARTA" required>
                            <input type="hidden" class="form-control" name="tipe_form" value="add">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">sarkes License</label>
                            <input type="text" class="form-control" id="sarkes_license" name="sarkes_license" placeholder="sarkes/001/2024" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Address</label>
                            <textarea class="form-control" id="sarkes_address" name="sarkes_address" placeholder="JL ABC"  required></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-single" style="width:100%" id="sarkes_district" name="sarkes_district">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Add SARKES</button>
                </div>
                </form>
            </div>
        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var table = $('#sarkes-table').DataTable({
                    "ajax": {
                        url: '<?php echo site_url("MasterData/sarkes_page"); ?>',
                        type: 'POST'
                    },
                    ...
                    "columnDefs": [{
...

                        {
                            ...
                            "render": function(data, type, row, meta) {
								if(role == 'superadmin'){
									return "<a href=<?php echo site_url('MasterData/edit_sarkes/'); ?>" +
										data +
            ...
            function edit(id) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: '<?php echo site_url('MasterData/hapus_sarkes'); ?>',
                            data: {
                                sarkes_id: sarkes_id
                            },
                            dataType: "json",
