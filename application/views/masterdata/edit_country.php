  ...
  <section class="content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="country_id"
                                      value="<?php echo $data_country[0]->country_id;?>">
                            <input type="text" class="form-control" name="country_name"   value="<?php echo $data_country[0]->country_name;?>"placeholder="" required>
                            
                        </div>  
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Status</label>
                            <select class="form-control" id="country_status" name="country_status" required>
                                <option value='1' <?php echo $data_country[0]->country_status == "1" ? 'selected' : ''; ?>>Aktif</option>
                                <option value='2' <?php echo $data_country[0]->country_status == "2" ? 'selected' : ''; ?>>Non Aktif</option>
                            </select>
                        </div>
      ...
      $(document).ready(function() {
          $('#edit-country').on('submit', function(event) {
