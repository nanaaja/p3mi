...
<section class="content">
        ...
        <div class='col-md-12'>
            <div class='box '>
                <div class='box-header'>
                    ...
                    <button class="btn btn-primary my-2 pull-right mx-3" data-toggle="modal" data-target="#add-country"><i class="fa fa-plus"></i> Add Data</button> &nbsp;
                ...
                <div class='box-body pad'>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="country-table" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>No</th>
    ...
    <!-- Modal tambah data -->
    <div class="modal fade add-country" id="add-country" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="tambah-country" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Name</label>
                            <input type="text" class="form-control" id="country_name" name="country_name" placeholder="ARAB SAUDI" required>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var table = $('#country-table').DataTable({
                    "ajax": {
                        url: '<?php echo site_url("MasterData/country_page"); ?>',
                        type: 'POST'
                    },
                    ...
                    "columnDefs": [{
...

                        {
                            ...
                            "render": function(data, type, row, meta) {
								if(role == 'superadmin'){
									return "<a href=<?php echo site_url('MasterData/edit_country/'); ?>" +
										data +
										"><button class='btn btn-primary btn-md' name='edit'><i class='fa fa-edit  text-white-50 mr-1'></i>  </button></a> <button type='button' class='btn btn-danger btn-md' name='hapus' country_id=" +
                ...
                $('#tambah-country').on('submit', function(event) {
                    event.preventDefault();
                    $.ajax({
                        type: "POST",
                        url: '<?php echo site_url('MasterData/add_country'); ?>',
                        ...
                        success: function(data) {
                            ...
                            Toast.fire({
                                type: 'success',
                                title: 'country Berhasil ditambahkan'
                            });
                            $('#tambah-country').trigger("reset");
                            setTimeout(function() {
                                window.location.href =
                                    '<?php echo site_url('MasterData/country'); ?>';
                                window.clearTimeout();
                            }, 1000);
                ...
                $(document).on('change', 'select[name="id_kecamatan"]', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $("select[name='country_district']").html(data)
            ...
            function edit(id) {
                ...
                Swal.fire({
                    title: 'Are you sure delete country this..?',
                    text: "",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: '<?php echo site_url('MasterData/hapus_country'); ?>',
                            data: {
