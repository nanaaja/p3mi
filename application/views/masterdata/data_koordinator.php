        ...
        <div class='col-md-12'>
            <div class='box '>
                <div class='box-header'>
                    <h3 class='box-title'>Data Koordinator Desa</h3>
                    <?php
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a href="<?php echo base_url('uploads/template_kordes.xlsx'); ?>">Download Template Import </a><br><br>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var table = $('#koordinator-table').DataTable({
                    "ajax": {
                        url: '<?php echo site_url("MasterData/koordinator_page"); ?>',
                        type: 'POST'
                    },
                    ...
                    buttons: [{
                        ...
                        exportOptions: {
                            columns: [0, 1, 2, 3, 4, 5, 6, 7] // Hanya kolom ke-0 sampai ke-3 yang diekspor
                        }
                    }],
                    "columnDefs": [{
                            "targets": [0],
                ...
                $(document).on('click', '.edit-koordinator', function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?php echo site_url('MasterData/get_koordinator'); ?>',
                        data: {
                        ...
                        success: function(data) {
                            ...
                            $("input[name='id_kelurahan']").val(data[0].id_kel)
                ...
                $('#tambah-koordinator').on('submit', function(event) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?php echo site_url('MasterData/add_koordinator'); ?>',
                        ...
                        success: function(data) {
                            ...
                            setTimeout(function() {
                                window.location.href =
                                    '<?php echo site_url('MasterData/koordinator'); ?>';
                                window.clearTimeout();
                            }, 1000);
            ...
            function edit(id) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: '<?php echo site_url('MasterData/hapus_koordinator'); ?>',
                            data: {
