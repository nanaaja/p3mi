                ...
                <div class='box-header'>
                    <h3 class='box-title'>Grafik Suara Pendukung </h3> (<?php
                                                                        ...
                                                                        if ($_GET['level'] == 1) {
                                                                            ...
                                                                            $data_wilayah = 'Per TPS ' . $detail_wilayah[0]->nama_kel;
                                ...
                                <tbody>
                                    ...
                                    foreach ($wilayah as $r) {
                                        ...
                                        <tr> <?php
                                                ...
                                                <th>
                                                    <?php
                                                    $link = site_url("MasterData/grafik_suara_pendukung_per_wil?level=2&id=" . $r->id_prov); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                ...
                                                <th>
                                                    <?php
                                                    $link = site_url("MasterData/grafik_suara_pendukung_per_wil?level=3&id=" . $r->id_kab); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                    <?php
                                                } elseif ($_GET['level'] == 3) { ?>
                                                <th>
                                                    <center><?= $no; ?>
                                                ...
                                                <th>
                                                    <center>
                                                        <?php
                                                        $link = site_url("MasterData/grafik_suara_pendukung_per_wil?level=4&id=" . $r->id_kec); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                        <?php
                                                    } elseif ($_GET['level'] == 4) { ?>
                                                <th>
                                                    <center><?= $no; ?>
                                                ...
                                                <th>
                                                    <center>
                                                        <?php
                                                        $link = site_url("MasterData/grafik_suara_pendukung_per_wil?level=5&id=" . $r->id_kel); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                        <?php
                                                    } elseif ($_GET['level'] == 5) { ?>
                                                <th>
                                                    <center><?= $no; ?>
                                                ...
                                                <th>
                                                    <center><?php
                                                            $link = site_url("MasterData/pendukung?id=" . $r->id_tps); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Data</button>
                                                </th>
                                            <?php } ?>
