  ...
  <section class="content">
                  ...
                  <div class='box-body pad'>
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="lsp_id"
                                      value="<?php echo $data_lsp[0]->lsp_id;?>">
                            <input type="text" class="form-control" name="lsp_name"   value="<?php echo $data_lsp[0]->lsp_name;?>"placeholder="" required>
                            
                        </div>  
                        <div class="form-group">
                            <label for="exampleFormControlInput1">License</label> 
                            <input type="text" class="form-control" name="lsp_license"   value="<?php echo $data_lsp[0]->lsp_license;?>"placeholder="" required>
                        </div>  
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Address</label> 
                            <textarea class="form-control" name="lsp_address" placeholder="" required><?php echo $data_lsp[0]->lsp_address;?></textarea>
                        </div> 
                        <div class="form-group">
                            ...
                            <select class="form-control" style="width:100%" name="id_provinsi">
                                ...
                                <?php foreach ($data_provinsi as $r) { ?>
                                    <option value='<?= $r->id_prov; ?>' <?= $data_lsp[0]->e_id_prov == $r->id_prov ? 'selected' : '';?>><?= $r->nama_prov; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-single" style="width:100%" id="id_kabupaten" name="id_kabupaten">
                                <?php foreach ($data_kabupaten as $r) { ?>
                                    <option value='<?= $r->id_kab; ?>' <?= $data_lsp[0]->d_id_kab == $r->id_kab ? 'selected' : '';?>><?= $r->nama_kab; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-single" style="width:100%" id="id_kecamatan" name="id_kecamatan">
                                <?php foreach ($data_kecamatan as $r) { ?>
                                    <option value='<?= $r->id_kec; ?>' <?= $data_lsp[0]->c_id_kec == $r->id_kec ? 'selected' : '';?>><?= $r->nama_kec; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>District</label>
                            <select class="form-control js-example-basic-single" style="width:100%" id="blsp_district" name="lsp_district">
                                <?php foreach ($data_kelurahan as $r) { ?>
                                    <option value='<?= $r->id_kel; ?>' <?= $data_lsp[0]->b_id_kel== $r->id_kel ? 'selected' : '';?>><?= $r->nama_kel; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="lsp_status" name="lsp_status" required>
                                <option value='1' <?php echo $data_lsp[0]->lsp_status == "1" ? 'selected' : ''; ?>>Aktif</option>
                                <option value='2' <?php echo $data_lsp[0]->lsp_status == "2" ? 'selected' : ''; ?>>Non Aktif</option>
                            </select>
                        </div>
      ...
      $(document).ready(function() {
          $('#edit-lsp').on('submit', function(event) {
