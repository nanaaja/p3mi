        ...
        <div class='col-md-6'>
            <div class='box '>
                <div class='box-header'>
                    <h3 class='box-title'>Grafik Suara Real Count </h3> (<?php
                                                                            $data_wilayah = '';
                                                                            if ($_GET['level'] == 1) {
                                                                                ...
                                                                                $data_wilayah = 'Kelurahan ' . $detail_wilayah[0]->nama_kel;
                ...
                <div class="box-header mx-4">
                    ...
                    <?php
                        ...
                        ?>
                            <a href="javascript:history.go(-1);" type="button" class="btn btn-danger pull-right mx-3"><i class="fa fa-reply"></i> List Kelurahan</button></a>
                        <?php
                        }
                    ?>
                </div>
                            ...
                            <table class="table table-bordered" id="caleg-table" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <center>Jumlah Suara Real
                                        </th>
                                        <th>
                                            <center>Jumlah Pendukung
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($wilayah as $r) {
                                        ...
                                        <tr> <?php
                                                ...
                                                <th><?= $r->nama_prov; ?></th>
                                                <th>
                                                    <center><?= $this->m_masterdata->jml_real_count($r->id_prov, 1)[0]->s; ?>
                                                </th>
                                                <th>
                                                    <?php
                                                    $link = site_url("MasterData/grafik_suara_real_vs_pendukung?level=2&id=" . $r->id_prov); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                ...
                                                <th>
                                                    <center><?= $this->m_masterdata->jml_real_count($r->id_kab, 2)[0]->s; ?>
                                                </th>
                                                <th>
                                                ...
                                                <th>
                                                    <?php
                                                    $link = site_url("MasterData/grafik_suara_real_vs_pendukung?level=3&id=" . $r->id_kab); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                    <?php
                                                } elseif ($_GET['level'] == 3) { ?>
                                                <th>
                                                    <center><?= $no; ?>
                                                ...
                                                <th>
                                                    <center><?= $this->m_masterdata->jml_real_count($r->id_kec, 3)[0]->s; ?>
                                                </th>
                                                <th>
                                                ...
                                                <th>
                                                    <center>
                                                        <?php
                                                        $link = site_url("MasterData/grafik_suara_real_vs_pendukung?level=4&id=" . $r->id_kec); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                        <?php
                                                } elseif ($_GET['level'] == 4) { ?>
                                                    <th>
                                                        <center><?= $no; ?>
                                                    ...
                                                    <th>
                                                        <center><?= $this->m_masterdata->jml_real_count($r->id_kel, 4)[0]->s; ?>
                                                    </th>
                                                    <th>
                                                    ...
                                                    <th>
                                                        <center>
                                                            <?php
                                                            $link = site_url("MasterData/grafik_suara_real_vs_pendukung?level=5&id=" . $r->id_kel); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Detail</button>
                                                            <?php
                                                    } elseif ($_GET['level'] == 5) { ?>
                                                <th>
                                                    <center><?= $no; ?>
                                                ...
                                                <th>
                                                    <center><?= $this->m_masterdata->jml_real_count($r->id_tps, 5)[0]->s; ?>
                                                </th>
                                                <th>
                                                    <center><?= $this->m_masterdata->jml_suara_pendukung_per($r->id_tps, 5); ?>
                                                </th>

                                                <th>
                                                    <center><?php
                                                            $link = site_url("Suara/data_suara?id=" . $r->id_tps); ?> <a href="<?= $link; ?>" type="button" class="btn btn-primary">Lihat Data</button>
                                                </th>
                                            <?php }
                                            ?>
                ...
                new Chart("myChart", {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'Grafik Data Suara Real Count ' + wil
                            }
                        }
                    }
                });
